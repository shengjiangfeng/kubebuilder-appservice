...
func (in *AppServiceSpec) DeepCopyInto(out *AppServiceSpec) {
	*out = *in
	...
	out.GatewayRegisterInfo = in.GatewayRegisterInfo
	if in.Envs != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GatewayRegisterInfo) DeepCopyInto(out *GatewayRegisterInfo) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GatewayRegisterInfo.
func (in *GatewayRegisterInfo) DeepCopy() *GatewayRegisterInfo {
	if in == nil {
		return nil
	}
	out := new(GatewayRegisterInfo)
	in.DeepCopyInto(out)
	return out
}
